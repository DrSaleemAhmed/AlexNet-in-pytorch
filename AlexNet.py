...
class FashionClass(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(256 * 6 * 6, 4096)# padding in conv1 changed its dim from 16*4*4
...
def main():
    ...
    optimizer = optim.SGD(model.parameters(), lr=argms.learning_rate)
  ...
  #  summary(model, input_size=(1, 128, 128))
    ...
    if argms.store_model:
        torch.save(model.state_dict(), "C:/Users/USER/Desktop/training_save/model_saving/fashoinmnist_cnnAlexNet.pt")
